...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-d7=(hefm$r#8@(k!!)3#q4o((sh66h*zx!fr=ksv(v@cfl@f4z')
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
        'matching.authentication.RemoteJWTAuthentication',
    ),
...
# ====================== OTHER SERVICES ======================
# user_service URL — used to fetch profiles and suggestions pool
